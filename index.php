...
<body style="overflow: hidden;">
    ...
    <nav class="c mcenter ccenter w12 hmin" id="main-menu">
        <div class="r mbetween ccenter w11-lmd w10-hmd w9-llg w8-hlg ovisible">
        ...
        <div class="i oauto" id="retracted-main-menu-lsm" style="display: none;">
    ...
    <header class="c mcenter ccenter w12 ovisible" id="main-banner">
        ...
        <div class="c p4 mcenter ccenter g4 w12 ovisible">
    ...
    <section class="c mcenter ccenter w12 hmin bgLight">
        <div class="r mbetween cstretch w12 w11-lmd w10-hmd w8-llg w6-hlg carousel">
            ...
            <div class="i w12 hauto oauto carousel-display" data-focused-item="0">
            ...
            <button class="i wmin hauto ovisible carousel-next-button" title="Próximo">
    ...
    <section class="c mcenter ccenter w12 hauto bgLight">
        <div class="c p12 r-lmd mcenter ccenter cstretch-lmd g12 w12 w11-lmd w10-hmd w8-llg w6-hlg hauto">
            <div class="c mbetween ccenter g12 w12 w6-lmd hauto">
            ...
            <div class="c mcenter ccenter g12 w12 w6-lmd hauto">
    ...
    <section class="r-hmd c-lsm ccenter-lsm mevenly-lsm bgDark w12-lsm " >
        ...
        <section class="c mcenter ccenter w12 hauto blur-effect">
            <div class="c r-lmd p12 mcenter mbetween-lmd ccenter g12 w12 w11-lmd w10-hmd w8-llg w6-hlg hauto">
                ...
                <aside class="r mcenter ccenter g2 wauto hauto wrap o1 o2-lmd">
                    ...
                    <a href="https://www.instagram.com/luthier_elizeu_manoel/" target="blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 30 30" fill="light"><path d="M 15 2 C 7.832 2 2 7.832 2 15 C 2 22.168 7.832 28 15 28 C 22.168 28 28 22.168 28 15 C 28 7.832 22.168 2 15 2 z M 11.666016 6 L 18.332031 6 C 21.457031 6 24 8.5420156 24 11.666016 L 24 18.332031 C 24 21.457031 21.457984 24 18.333984 24 L 11.667969 24 C 8.5429688 24 6 21.457984 6 18.333984 L 6 11.667969 C 6 8.5429688 8.5420156 6 11.666016 6 z M 11.666016 8 C 9.6450156 8 8 9.6459688 8 11.667969 L 8 18.333984 C 8 20.354984 9.6459688 22 11.667969 22 L 18.333984 22 C 20.354984 22 22 20.354031 22 18.332031 L 22 11.666016 C 22 9.6450156 20.354031 8 18.332031 8 L 11.666016 8 z M 19.667969 9.6660156 C 20.035969 9.6660156 20.333984 9.9640312 20.333984 10.332031 C 20.333984 10.700031 20.035969 11 19.667969 11 C 19.299969 11 19 10.700031 19 10.332031 C 19 9.9640312 19.299969 9.6660156 19.667969 9.6660156 z M 15 10 C 17.757 10 20 12.243 20 15 C 20 17.757 17.757 20 15 20 C 12.243 20 10 17.757 10 15 C 10 12.243 12.243 10 15 10 z M 15 12 A 3 3 0 0 0 15 18 A 3 3 0 0 0 15 12 z"></path></svg></a>
