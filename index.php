    ...
    <nav class="c mcenter ccenter w12 hmin" id="main-menu">
        <div class="r mbetween ccenter w11-lmd w10-hmd w9-llg w8-hlg ns">
            ...
            <ul class="r mend ccenter wauto retractable-menu">
                ...
                <li class="i wmax"><a class="i wmax main-menu-link hover-line-bottom retractable-menu-option" href="<?="$ROOT_PATH/#services"?>">SERVIÇOS</a></li>
                <li class="i wmax"><a class="i wmax main-menu-link hover-line-bottom retractable-menu-option" href="<?="$ROOT_PATH/#contact"?>">CONTATO</a></li>
        ...
        <div class="i s" id="retracted-main-menu-lmd" style="display: none;">
            <div class="c mcenter ccenter w12 hmin">
                ...
                <li class="i w12"><a class="i w12 main-menu-link hover-color-change text-center" href="<?="$ROOT_PATH/#services"?>">SERVIÇOS</a></li>
                <li class="i w12"><a class="i w12 main-menu-link hover-color-change text-center" href="<?="$ROOT_PATH/#contact"?>">CONTATO</a></li>
            ...
            <div class="r w2-hmd w12-lsm p-footer " >
                <div class="c w12-lsm ccenter-lsm cstart-hmd ">
                    ...
                    <ul class="c gap-2 no-overflow ">
                        ...
                        <li><a class="link-footer" href="#projetos">PROJETOS</a></li>
                        <li><a class="link-footer" href="#servicos">SERVIÇOS</a></li>
                        <li><a class="link-footer" href="#contato">CONTATO</a></li>
                        <li><a class="link-footer" href="">LOGIN</a></li>
                    </ul>
                </div>
            </div>
