    ...
    <main id="login-main-banner" class="c mcenter ccenter w12">
        <section class="c p4 mcenter ccenter cstart-lmd w12 w8-lmd w7-hmd w6-llg w5-hlg ns">
            <div class="c mcenter ccenter g2 wauto hauto">
                <a class="i w12 bgLight main-menu-link" style="border-radius: 20px;" href="<?="$ROOT_PATH/#home"?>"><img class="i w12" style="height: 4rem;" src="./assets/img/atelier_logo.svg" alt="Atelier Elizeu Manoel"></a>
                <form class="c p4 mcenter ccenter g4 w12 hauto bgLight" style="border-radius: 20px;">
                    ...
                    <div class="c mcenter cend g1 w12 hauto ns">
                        ...
                        <a class="i wauto hauto ns forgot-password-link" href="<?="$ROOT_PATH/#home"?>">Esqueci minha senha</a>
                    </div>
